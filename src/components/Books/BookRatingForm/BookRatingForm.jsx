...
function BookRatingForm({ rating, setRating, userId, setBook, id, userRated }) {
  ...
  useEffect(() => {
    console.log("BookRatingForm id (before formState check):", id);
    ...
    console.log("BookRatingForm id (after formState check):", id);
  }, [formState, id, setRating]);

  const onSubmit = async () => {
    console.log("Submitting rating for book ID:", id);
